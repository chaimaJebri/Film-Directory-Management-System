...
public class Film {
	...
	//constructs a film object without the id
	...
	//constructs a film object with the id, title, year, director, stars and review
	...
	//returns a string representation for the film object
	@Override
