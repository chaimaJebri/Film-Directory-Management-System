# Film-Directory-Management-System
README
  

Overview
This folder contains the code for the Films web application which is developed with different architectural approaches (MVC and RESTful web service with a JavaScript client). 
The web application allows users to perform CRUD functionalities on a films database. Additionally, it exchanges data in 3 different data formats (JSON, XML, and Text) through a RESTful web service.
Technologies Used
* Java 11
* Apache Tomcat v9.0
* MySQL Database
...
Endpoint URL: http://localhost:8080/FilmRestful/film-api
...
* Run the project (Right click on the project – Run as – Run on server) | Upon initial launch of the project, a welcome page with an animated video is displayed. By clicking on the “Browse Films” button, users will be directed to the main web view where they can perform CRUD functionalities on the films.
